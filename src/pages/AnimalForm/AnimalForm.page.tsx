...
const AnimalForm = () => {
	...
	return (
		<PageContainer maxWidth="4xl">
			...
			{/* Species and breed are required, so with none registered the form is a
			    dead end that only says "no options available" in the dropdown. */}
			{!isEditing && speciesOptions.length === 0 && (
				<div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6 flex items-start gap-3">
					<i className="i-material-symbols-info bg-amber-600! dark:bg-amber-400! w-5! h-5! shrink-0 mt-0.5" />
					<div className="flex-1">
						...
						<button
							...
							className="mt-2 text-sm font-medium text-amber-900 dark:text-amber-100 underline underline-offset-2"
						>
							{t('noSpecies.cta')}
						</button>
					</div>
