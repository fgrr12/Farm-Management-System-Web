...
import { VoiceRecorder } from '@/components/business/VoiceRecorder'
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
			<div className="max-w-6xl mx-auto p-3 sm:p-4 lg:p-6 xl:p-8">
				...
				>
					{t('voice:accessibility.skipToRecording')}
				</a>
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
							...
							<div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-600 transition-all duration-300 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/20">
								<h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
									...
									{t('voice:animalManagement')}
								</h3>
								<ul className="space-y-2">
									{(t('voice:examples.animals', { returnObjects: true }) as string[]).map(
										(example, index) => (
											<li
												key={index}
							...
							<div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-600 transition-all duration-300 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/20">
								<h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
									...
									{t('voice:healthRecords')}
								</h3>
								<ul className="space-y-2">
									{(t('voice:examples.health', { returnObjects: true }) as string[]).map(
										(example, index) => (
											<li
												key={index}
												className="text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-600 p-3 rounded-lg border border-gray-200 dark:border-gray-500"
							...
							<div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-600 transition-all duration-300 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/20">
								<h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
									...
									{t('voice:productionRecords')}
								</h3>
								<ul className="space-y-2">
									{(t('voice:examples.production', { returnObjects: true }) as string[]).map(
										(example, index) => (
											<li
												key={index}
												className="text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-600 p-3 rounded-lg border border-gray-200 dark:border-gray-500"
							...
							<div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-600 transition-all duration-300 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/20">
								<h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
									...
									{t('voice:taskManagement')}
								</h3>
								<ul className="space-y-2">
									{(t('voice:examples.tasks', { returnObjects: true }) as string[]).map(
										(example, index) => (
											<li
												key={index}
												className="text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-600 p-3 rounded-lg border border-gray-200 dark:border-gray-500"
					...
					<div className="p-4 sm:p-6 lg:p-8">
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
							<div className="text-center">
								...
								<h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">1. Record</h3>
								<p className="text-sm text-gray-600 dark:text-gray-400">
									{t('voice:instructions.record')}
								</p>
							</div>
							<div className="text-center">
								...
								<h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">2. Process</h3>
								<p className="text-sm text-gray-600 dark:text-gray-400">
									{t('voice:instructions.process')}
								</p>
							</div>
							<div className="text-center">
								...
								<h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Execute</h3>
								<p className="text-sm text-gray-600 dark:text-gray-400">
									{t('voice:instructions.execute')}
								</p>
							</div>
							<div className="text-center">
								...
								<h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Review</h3>
								<p className="text-sm text-gray-600 dark:text-gray-400">
									{t('voice:instructions.review')}
								</p>
							</div>
						</div>
					</div>
