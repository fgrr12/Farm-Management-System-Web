...
export const BackButton: FC<BackButtonProps> = memo((props) => {
	...
	return (
		<button
			type="button"
			className="items-center gap-2 px-3 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all duration-200 hidden md:inline-flex ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:ring-offset-2 dark:focus:ring-offset-gray-900 hover:scale-105 active:scale-95 animate-fade-in-left"
