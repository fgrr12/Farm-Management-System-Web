...
const PAGE_SEO_CONFIG: Record<string, PageSEOConfig> = {
	'/': {
		...
		description:
			'Access your farm dashboard to view animal statistics, recent activities, and manage your livestock operations efficiently.',
	...
	'/animals': {
		...
		description:
			'Manage your livestock inventory, track animal health, breeding records, and monitor your cattle with our comprehensive animal management system.',
		keywords:
			'animal management, livestock tracking, cattle inventory, animal health records, breeding management',
	},
	'/animals/add': {
		title: 'Add New Animal - Register Livestock',
		description:
			'Register new animals in your farm management system. Add cattle details, health information, and breeding records.',
	...
	'/animals/edit': {
		...
		description:
			'Update animal information, health records, and breeding data in your farm management system.',
	...
	'/animal': {
		...
		description:
			'View detailed information about individual animals including health records, breeding history, and production data.',
	...
	'/employees': {
		...
		description:
			'Manage your farm employees, assign roles, track responsibilities, and organize your agricultural workforce.',
		keywords:
			'employee management, farm staff, agricultural workers, workforce management, farm employees',
	},
	'/employees/add': {
		title: 'Add Employee - Register Farm Staff',
		description:
			'Add new employees to your farm management system. Register staff members and assign roles and responsibilities.',
		keywords:
			'add employee, register staff, new farm worker, employee registration, farm staff entry',
	},
	'/employees/edit': {
		title: 'Edit Employee Information - Update Staff Records',
		description:
			'Update employee information, roles, and responsibilities in your farm management system.',
	...
	'/tasks/add': {
		...
		description:
			'Create new farm tasks, set schedules, assign responsibilities, and organize agricultural activities.',
		keywords: 'create task, schedule activity, new farm task, task creation, farm scheduling',
	},
	'/my-account': {
		title: 'My Account - User Profile Settings',
		description:
			'Manage your account settings, update profile information, and configure your farm management preferences.',
		keywords:
			'user account, profile settings, account management, user preferences, profile update',
	},
	'/my-species': {
		title: 'Species Management - Livestock Categories',
		description:
			'Manage livestock species and breeds in your farm. Configure animal categories and breeding information.',
		keywords:
			'species management, livestock breeds, animal categories, breed management, cattle species',
	},
	'/billing-card': {
		title: 'Billing Information - Payment Management',
		description:
			'Manage your billing information, payment methods, and subscription details for the farm management system.',
		keywords:
			'billing information, payment management, subscription, farm software billing, payment methods',
	},
	'/login': {
		title: 'Login - Access Your Farm Management System',
		description:
			'Sign in to your cattle farm management system to access livestock tracking, employee management, and farm operations.',
...
export const SEO = ({
	...
	useEffect(() => {
		...
		const finalDescription =
			...
			'Professional farm management software for livestock operations'
